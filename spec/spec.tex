...
$\delta_{\mathsf{ang}}$ & $::=$ & $\mathsf{join}(a : \mathsf{ang}; \; b : \mathsf{ang})$ &  & This angle's sweep is equal to the sum of the sweeps of $a$ and $b$. \\
 ...
 & & $\mathsf{between}(k : \mathsf{ln}; \; l : \mathsf{ln})$ & \raisebox{-.5\height}{\includegraphics[width=\buttondim]{buttons/skew}} & This angle's sweep is the sweep between the lines $k$ and $l$. \\
\end{tabularx}
