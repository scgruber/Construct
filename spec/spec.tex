...
Tony DeRose's analysis of coordinate-free geometric calculations \cite{derose1989coordinatefree}, though envisioned in the context of traditional text-based programming languages, provides a model of geometric computation that more closely mirrors pen-and-paper geometry.
The Geometric Machine \cite{reiser2003programming} developed a computer system in which the memory is envisioned as a geometric space rather than the familiar Turing-machine one-dimensional stream of symbols.
